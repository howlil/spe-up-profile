    ...
    <div className='min-h-screen bg-white'>
      ...
      >
        ...
        <div className='relative z-10 flex h-full items-center justify-center'>
          <MotionFadeIn className='mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8'>
            ...
            <div className='flex  flex-col justify-center'>
              <div className='space-y-6 text-base leading-7 text-gray-700 sm:text-lg sm:leading-8'>
                <p className='text-justify'>
                  ...
                  Universitas Pertamina. SPE Universitas Pertamina SC is under
                  SPE Java Section.
                </p>

                <p className='text-justify'>
                  We are linked to SPE Student Chapter around the world,
                  allowing us to act as vibrant intermediaries between
                  Universitas Pertamina students to students from prestigious
                  universities globally. This interconnected community not only
                  provides a platform for knowledge exchange but also cultivates
                  skills essential for career advancement, ensuring that student
                  members are well-equipped for success in the energy sector.
                </p>
              </div>
            </div>
          </div>
