    ...
    <>
      <header className="h-auto min-h-14 px-4 py-3 sm:px-6 bg-white border-b border-gray-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button onClick={() => router.push('/admin/articles/categories')} className="h-9 px-3 sm:px-4 border border-purple-300 bg-purple-50 text-purple-700 rounded-md text-xs sm:text-sm font-medium flex items-center gap-1.5 hover:bg-purple-100 transition-colors">
            <Tag className="w-4 h-4 flex-shrink-0" />Categories
          </button>
          <button onClick={() => router.push('/admin/articles/new')} className="h-9 px-3 sm:px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-xs sm:text-sm font-medium flex items-center gap-1.5 transition-colors">
            <Plus className="w-4 h-4 flex-shrink-0" />New Article
          </button>
        </div>
      </header>
