    ...
    <div className={`group ${className}`}>
      ...
      <div className='relative'>
        <input
          ...
          name={name}
          required={required}
          className='w-full px-4 py-3 bg-white/50 border-2 border-gray-200 rounded-xl focus:border-[#3C8C98] focus:bg-white focus:outline-none transition-all duration-300 placeholder:text-gray-400'
